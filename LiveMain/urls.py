...
# url 경로 지정 부분(client 단 통신)->눈에 보이는 url 
    path('elements/', v_live_test.elements, name='elements'),
    path('generic/', v_live_test.generic, name='generic'),
    path('index/', v_live_test.index, name='index'),
